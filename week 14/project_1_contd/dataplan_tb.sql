...
CREATE TABLE public.dataplan (
    ...
    data_duration_days_ integer NOT NULL,
    data_price_naira_ character varying(10) NOT NULL
);
...
COPY public.dataplan (data_id, data_size, data_duration_days_, data_price_naira_) FROM stdin;
1	350MB	2	200
2	1.8GB	14	600
3	3.9GB	30	1000
4	7.5GB	30	1500
